import footerLogo from '../../assets/fevIcon.png'
   ...
   return (
      <footer className=" divide-y  bg-footerImg bg-no-repeat bg-center text-gray-100">
         <div className="bg-[#000208A1]">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
               <div className="lg:w-1/3">
                  <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                     ...
                     <span className="self-center text-2xl font-semibold font-classic">Valley of Serenity</span>
                  </a>
               </div>
            ...
            <div className="py-6 text-sm text-center text-gray-400">© 2024 Valley of Serenity Co. All rights reserved.</div>
         </div>
      </footer>
   );
};
